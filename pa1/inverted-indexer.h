...
/*
 *	This structure contains an keys of sorted lists that contain strings that
 ...
 *  that maintains the index spot in the array of Elements
...
/*
 * This contains the information that is stored in each element of the array
 *  that keeps track of an ELements information Element (Nodes) containing
 */ 
