...
/*I am using somebody elses Tokenizer and SortedList code. The reason behind this is because of my partner change. The code that I am 
using for those files belong to Alexander Tang. This has been discussed prior to submission
https://github.com/alexandermtang/systems_programming/blob/master/indexer/README.pdf
*/


char isDelimiter(char character, char* delimiters) {
...
char *TKGetNextToken(TokenizerT *tk) {
	...
	while(tk->current_position - tk->copied_string < strlen(tk->copied_string)) {
		if(!isDelimiter(*tk->current_position, tk->delimiters)) {
